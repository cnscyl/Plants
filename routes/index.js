...
const categoryRoutes = require('./categories'); // Category CRUD işlemleri
...
router.use('/categories', categoryRoutes); // /api/categories/* endpoint'leri
...
router.get('/', (req, res) => {
    ...
    res.json({
        ...
        endpoints: {
            ...
            categories: '/api/categories', // Kategori işlemleri
        }
    });
});
